...
namespace SymOrdinary
{
    ...
    public class Ordinary
    {
        ...
        public static int NextId(string tableName, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
        ...
        public static bool sqlUpdateCmd(SqlCommand Cmd, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
        ...
        public static bool sqlUpdate(string sqlText, SqlConnection VcurrConn, SqlTransaction Vtransaction)
        {
