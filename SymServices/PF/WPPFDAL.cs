...
//        }
        ...
        //public string[] PFProcess(decimal TotalProfit, string FiscalYearDetailId, ShampanIdentityVM auditvm, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null)
        //{
        //    #region Variables
        ...
        //        string[] cValues = { Convert.ToDecimal(TotalProfit).ToString(), FiscalYearDetailId };
        ...
        //                {
        //                    TotalProfit = Convert.ToDecimal(row["Id"]);

        //                    retResults = PFProcessSingle(FiscalYearDetailId, TotalProfit, auditvm, null, null);
        //                }
        //            }
        ...
        public string[] PFProcess(decimal? TotalProfit, string FiscalYearDetailId, int? FiscalYear,
                          ShampanIdentityVM auditvm,
