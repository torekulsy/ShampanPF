...
order by SectionOrderNo ";
        ...
        private string[] InsertPFHeader(int FiscalYearDetailId,string PId, SqlConnection currConn, SqlTransaction transaction, ShampanIdentityVM auditvm)
        {
            ...
            {                       
                ...
                sqlText = @"insert into PFHeader (Id,Code,[FiscalYearDetailId],[ProjectId],[EmployeePFValue],[EmployeerPFValue],[Post],
                            ...
                            @CreatedBy,@CreatedAt,@CreatedFrom,@LastUpdateBy,@LastUpdateAt,@LastUpdateFrom)  
                          ";

                string deleteCurrent = @" DELETE FROM PFHeader  WHERE FiscalYearDetailId=@FiscalYearDetailId and ProjectId=@ProjectId";
        ...
        private string[] UpdatePFHeader(int FiscalYearDetailId, string PId, SqlConnection currConn, SqlTransaction transaction, ShampanIdentityVM auditvm)
        {
            #region Variables
            string[] retResults = new string[6];
            retResults[0] = "Fail";//Success or Fail
            ...
            try
            {
                ...
                string id = @"Select SUM(EmployeePFValue) EmployeePFValue, SUM(EmployeerPFValue) EmployeerPFValue from PFDetails where FiscalYearDetailId=@FiscalDetailYearId and ProjectId=@ProjectId";
        ...
        public string[] ImportExcelFile(string fullPath, string fileName, ShampanIdentityVM auditvm, int branchId, SqlConnection VcurrConn = null, SqlTransaction Vtransaction = null, int FYDId = 0, string PId="")
        {
            #region Initializ
            string sqlText = "";
            int Id = 0;
            ...
            try
            {
                ...
                PFDetailVM vm = new PFDetailVM();               
                 ...
                 retResults = InsertPFHeader(FYDVM.Id,PId, currConn, transaction, auditvm);
                 ...
                 if (retResults[0] == "Success")
                 {
                         ...
                         else
                         {
                             ...
                             else
                             {
                                 ...
                                 else
                                 {
                                     ...
                                     vm.IsActive = true;
                                     vm.IsArchive = false;
                                     vm.CreatedBy = auditvm.CreatedAt;
                                     vm.CreatedAt = auditvm.CreatedBy;
                     ...
                     retResults = UpdatePFHeader(FYDVM.Id, PId, currConn, transaction, auditvm);
