...
{
    public class InfoEmployerController : Controller
    {
        //
        // GET: /Common/InfoEmployer/
       ...
       [Authorize]
        public ActionResult _index(JQueryDataTableParamModel param)
        {
            ...
            InfoEmployerRepo _repo = new InfoEmployerRepo();
            var getAllData = _repo.SelectAll();
            IEnumerable<InfoEmployerVM> filteredData;
            ...
            Func<InfoEmployerVM, string> orderingFunction = (c =>
