...
{
    public class BlockJobSeekerController : Controller
    {
        //
        // GET: /Common/BlockJobSeeker/
        ...
        public ActionResult _index(JQueryDataTableParamModel param)
        {
            ...
            var WebsiteFilter = Convert.ToString(Request["sSearch_16"]);
            var BlockStatusFilter = Convert.ToString(Request["sSearch_17"]);
            ...
            BlockJobSeekerRepo _repo = new BlockJobSeekerRepo();
            var getAllData = _repo.SelectAll();
            IEnumerable<BlockJobSeekerVM> filteredData;
            ...
            if (!string.IsNullOrEmpty(param.sSearch))
            {
                ...
                filteredData = getAllData
                   .Where(c =>
                         ...
                         ||isSearchable16 && c.Website.ToLower().Contains(param.sSearch.ToLower()) 
                         ||isSearchable17 && c.BlockStatus.ToLower().Contains(param.sSearch.ToLower()) 
                    );
            }
            else
            {
            ...
            Func<BlockJobSeekerVM, string> orderingFunction = (c =>
                ...
                sortColumnIndex == 16 && isSortable_16 ? c.Website                             :
                sortColumnIndex == 17 && isSortable_17 ? c.BlockStatus                             :
            "");                                     
