    ...
    public class AssetController : Controller
    {
        ...
        public ActionResult ExportExcell(ExportImportVM VM)
        {
            ...
            try
            {
                ...
                dt = _repo.SelectAssetInfo(VM);

                #region Excel

                string filename = "AssetInfo Data";
                var workSheet = excel.Workbook.Worksheets.Add("AssetInfo Data");
        ...
        public ActionResult UploadExcel(AssetVM vm)
        {
            string[] result = new string[6];
            try
            {
                ...
                result = new AssetRepo().ImportExcelFile(vm);
                Session["result"] = result[0] + "~" + result[1];
                return RedirectToAction("Index");
            }
            catch (Exception)
