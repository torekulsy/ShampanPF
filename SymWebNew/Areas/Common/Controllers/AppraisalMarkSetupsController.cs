...
{
    [Authorize]
    public class AppraisalMarkSetupsController : Controller
    {
        //
        // GET: /Common/AppraisalMarkSetups/
        ...
        public ActionResult _index(JQueryDataTableParamModel param)
        {
            ...
            Func<AppraisalMarkSetupsVM, string> orderingFunction = (c =>
                ...
                sortColumnIndex == 10 && isSortable_10 ? Convert.ToString(c.PeriodName) :
                "");
        ...
        [Authorize(Roles = "Master,Admin,Account")]
        [HttpPost]
        public ActionResult Create(AppraisalMarkSetupsVM appraisalMarkSetups)
        {
            ...
            try
            {
                result = new AppraisalMarkSetupsRepo().Insert(appraisalMarkSetups);
            ...
            catch (Exception)
            {
                ...
                return View(appraisalMarkSetups);
            }
        }
