...
{
    [Authorize]
    public class EnumDivisionController : Controller
    {
        //
        // GET: /Enum/EnumDivision/
         SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumDivisionRepo _repo = new EnumDivisionRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamModel param, string code, string name)
        {
            ...
            IEnumerable<EnumDivisionVM> filteredData;
            ...
            if (nameFilter != "" || country_EFilter != "" || isActiveFilter != "")
            {
            ...
            Func<EnumDivisionVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumDivisionVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumDivisionVM vm, string btn)
        {
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
