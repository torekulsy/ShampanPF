...
{
    [Authorize]
    public class EnumImmigrationTypeController : Controller
    {
        //
        // GET: /Enum/EnumImmigrationType/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumImmigrationTypeRepo _repo = new EnumImmigrationTypeRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumImmigrationTypeVM> filteredData;
            ...
            Func<EnumImmigrationTypeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumImmigrationTypeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumImmigrationTypeVM vm, string btn)
        {
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
