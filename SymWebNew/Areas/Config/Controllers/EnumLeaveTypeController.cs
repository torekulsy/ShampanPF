...
{
    [Authorize]
    public class EnumLeaveTypeController : Controller
    {
        //
        // GET: /Enum/EnumLeaveType/
          SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumLeaveTypeRepo _repo = new EnumLeaveTypeRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumLeaveTypeVM> filteredData;
            ...
            Func<EnumLeaveTypeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumLeaveTypeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumLeaveTypeVM vm, string btn)
        {
