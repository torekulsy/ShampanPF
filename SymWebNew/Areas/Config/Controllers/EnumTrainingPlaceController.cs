...
{
    [Authorize]
    public class EnumTrainingPlaceController : Controller
    {
        //
        // GET: /Enum/EnumTrainingPlace/
          SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumTrainingPlaceRepo _repo = new EnumTrainingPlaceRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumTrainingPlaceVM> filteredData;
            ...
            Func<EnumTrainingPlaceVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumTrainingPlaceVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumTrainingPlaceVM vm, string btn)
        {
