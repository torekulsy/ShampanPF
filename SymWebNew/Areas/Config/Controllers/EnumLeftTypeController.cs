...
{
    [Authorize]
    public class EnumLeftTypeController : Controller
    {
        //
        // GET: /Enum/EnumLeftType/
         SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumLeftTypeRepo _repo = new EnumLeftTypeRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumLeftTypeVM> filteredData;
            ...
            Func<EnumLeftTypeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumLeftTypeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumLeftTypeVM vm, string btn)
        {
