...
{
    [Authorize]
    public class EnumSalutationController : Controller
    {
        //
        // GET: /Enum/EnumSalutation/
          SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumSalutationRepo _repo = new EnumSalutationRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumSalutationVM> filteredData;
            ...
            Func<EnumSalutationVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumSalutationVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumSalutationVM vm, string btn)
        {
