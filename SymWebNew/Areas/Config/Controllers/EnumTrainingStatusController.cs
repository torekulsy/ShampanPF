...
{
    [Authorize]
    public class EnumTrainingStatusController : Controller
    {
        //
        // GET: /Enum/EnumTrainingStatus/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumTrainingStatusRepo _repo = new EnumTrainingStatusRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumTrainingStatusVM> filteredData;
            ...
            Func<EnumTrainingStatusVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumTrainingStatusVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumTrainingStatusVM vm, string btn)
        {
