...
{
    [Authorize]
    public class EnumEMPTypeController : Controller
    {
        //
        // GET: /Config/EnumEMPType/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumEMPTypeRepo _repo = new EnumEMPTypeRepo();
        ...
        public ActionResult _index(JQueryDataTableParamModel param, string code, string name)
        {
            ...
            IEnumerable<EnumEMPTypeVM> filteredData;
            ...
            Func<EnumEMPTypeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumEMPTypeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumEMPTypeVM vm, string btn)
        {
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
