...
{
    [Authorize]
    public class EnumProfessionalDegreeController : Controller
    {
        //
        // GET: /Config/EnumProfessionalDegree/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumProfessionalDegreeRepo _repo = new EnumProfessionalDegreeRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamModel param, string code, string name)
        {
            ...
            IEnumerable<EnumProfessionalDegreeVM> filteredData;
            ...
            if (!string.IsNullOrEmpty(param.sSearch))
            {
                ...
                filteredData = getAllData
                   .Where(c => isSearchable1 && c.ProfessionalDegrees.ToLower().Contains(param.sSearch.ToLower())
                               ||
            ...
            if (nameFilter != "" || isActiveFilter != "" || remarksFilter != "")
            {
                filteredData = filteredData
                                .Where(c => (nameFilter == "" || c.ProfessionalDegrees.ToLower().Contains(nameFilter.ToLower()))
                                            &&
            ...
            Func<EnumProfessionalDegreeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.ProfessionalDegrees :
            ...
            { 
                ...
                , c.ProfessionalDegrees //+ "~" + Convert.ToString(c.Id)
        ...
        [HttpPost]
        public ActionResult Create(EnumProfessionalDegreeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumProfessionalDegreeVM vm, string btn)
        {
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
