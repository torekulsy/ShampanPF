...
{
    [Authorize]
    public class EnumSalaryPortionController : Controller
    {
        //
        // GET: /Enum/EnumSalaryPortion/

        EnumSalaryPortionRepo _repo = new EnumSalaryPortionRepo();
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumSalaryPortionVM> filteredData;
            ...
            Func<EnumSalaryPortionVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumSalaryPortionVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumSalaryPortionVM vm, string btn)
        {         
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
