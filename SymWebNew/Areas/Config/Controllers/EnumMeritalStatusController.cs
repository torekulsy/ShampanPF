...
{
    [Authorize]
    public class EnumMeritalStatusController : Controller
    {
        //
        // GET: /Enum/EnumMeritalStatus/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumMeritalStatusRepo _repo = new EnumMeritalStatusRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumMeritalStatusVM> filteredData;
            ...
            Func<EnumMeritalStatusVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumMeritalStatusVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumMeritalStatusVM vm, string btn)
        {
