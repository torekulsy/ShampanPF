...
{
    [Authorize]
    public class EnumSalaryPayModeController : Controller
    {
        //
        // GET: /Enum/EnumSalaryPayMode/

        EnumSalaryPayModeRepo _repo = new EnumSalaryPayModeRepo();
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumSalaryPayModeVM> filteredData;
            ...
            Func<EnumSalaryPayModeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumSalaryPayModeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumSalaryPayModeVM vm, string btn)
        {
