...
{
    [Authorize]
    public class EnumNationalityController : Controller
    {
        //
        // GET: /Enum/EnumNationality/
            SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumNationalityRepo _repo = new EnumNationalityRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumNationalityVM> filteredData;
            ...
            Func<EnumNationalityVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumNationalityVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumNationalityVM vm, string btn)
        {
