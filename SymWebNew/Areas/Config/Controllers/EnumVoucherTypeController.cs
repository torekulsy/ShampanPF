...
{
    [Authorize]
    public class EnumVoucherTypeController : Controller
    {
        //
        // GET: /Enum/EnumVoucherType/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumVoucherTypeRepo _repo = new EnumVoucherTypeRepo();
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumVoucherTypeVM> filteredData;
            ...
            Func<EnumVoucherTypeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumVoucherTypeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumVoucherTypeVM vm, string btn)
        {
