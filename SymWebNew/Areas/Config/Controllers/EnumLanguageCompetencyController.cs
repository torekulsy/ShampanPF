...
{
    [Authorize]
    public class EnumLanguageCompetencyController : Controller
    {
        //
        // GET: /Enum/EnumLanguageCompetency/
          SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumLanguageCompetencyRepo _repo = new EnumLanguageCompetencyRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumLanguageCompetencyVM> filteredData;
            ...
            Func<EnumLanguageCompetencyVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumLanguageCompetencyVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumLanguageCompetencyVM vm, string btn)
        {
