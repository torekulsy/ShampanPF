...
{
    [Authorize]
    public class EnumLanguageController : Controller
    {
        //
        // GET: /Enum/EnumLanguage/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumLanguageRepo _repo = new EnumLanguageRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumLanguageVM> filteredData;
            ...
            Func<EnumLanguageVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumLanguageVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumLanguageVM vm, string btn)
        {
