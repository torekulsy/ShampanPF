...
{
    [Authorize]
    public class EnumSkillQualityController : Controller
    {
        //
        // GET: /Enum/EnumSkillQuality/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumSkillQualityRepo _repo= new EnumSkillQualityRepo();
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumSkillQualityVM> filteredData;
            ...
            Func<EnumSkillQualityVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumSkillQualityVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumSkillQualityVM vm, string btn)
        {
