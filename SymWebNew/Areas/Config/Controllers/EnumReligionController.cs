...
{
    [Authorize]
    public class EnumReligionController : Controller
    {
        //
        // GET: /Enum/EnumReligion/
         SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumReligionRepo _repo = new EnumReligionRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumReligionVM> filteredData;
            ...
            Func<EnumReligionVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumReligionVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumReligionVM vm, string btn)
        {
