...
{
    [Authorize]
    public class EnumDegreeController : Controller
    {
        //
        // GET: /Enum/EnumDegree/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumDegreeRepo _repo = new EnumDegreeRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamModel param, string code, string name)
        {
            ...
            IEnumerable<EnumDegreeVM> filteredData;
            ...
            Func<EnumDegreeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumDegreeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumDegreeVM vm, string btn)
        {
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
