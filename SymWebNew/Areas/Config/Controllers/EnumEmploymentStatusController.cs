...
{
    [Authorize]
    public class EnumEmploymentStatusController : Controller
    {
        //
        // GET: /Enum/EnumEmploymentStatus/

        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumEmploymentStatusRepo _repo = new EnumEmploymentStatusRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumEmploymentStatusVM> filteredData;
            ...
            Func<EnumEmploymentStatusVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumEmploymentStatusVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumEmploymentStatusVM vm, string btn)
        {
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
