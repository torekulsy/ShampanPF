...
{
    [Authorize]
    public class EnumTravelTypeController : Controller
    {
        //
        // GET: /Enum/EnumTravelType/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumTravelTypeRepo _repo = new EnumTravelTypeRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamModel param, string code, string name)
        {
            ...
            IEnumerable<EnumTravelTypeVM> filteredData;
            ...
            Func<EnumTravelTypeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumTravelTypeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumTravelTypeVM vm, string btn)
        {
