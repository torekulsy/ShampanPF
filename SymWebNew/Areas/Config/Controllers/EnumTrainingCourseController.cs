...
{
    [Authorize]
    public class EnumTrainingCourseController : Controller
    {
        //
        // GET: /Enum/EnumTrainingCourse/
            SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumTrainingCourseRepo _repo= new EnumTrainingCourseRepo();
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumTrainingCourseVM> filteredData;
            ...
            Func<EnumTrainingCourseVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumTrainingCourseVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumTrainingCourseVM vm, string btn)
        {
