...
{
    [Authorize]
    public class EnumLanguageFluencyController : Controller
    {
        //
        // GET: /Enum/EnumLanguageFluency/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumLanguageFluencyRepo _repo = new EnumLanguageFluencyRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumLanguageFluencyVM> filteredData;
            ...
            Func<EnumLanguageFluencyVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumLanguageFluencyVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumLanguageFluencyVM vm, string btn)
        {
