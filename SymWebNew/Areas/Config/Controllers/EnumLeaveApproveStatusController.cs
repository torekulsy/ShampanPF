...
{
    [Authorize]
    public class EnumLeaveApproveStatusController : Controller
    {
        //
        // GET: /Enum/EnumLeaveApproveStatus/
         SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumLeaveApproveStatusRepo _repo = new EnumLeaveApproveStatusRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumLeaveApproveStatusVM> filteredData;
            ...
            Func<EnumLeaveApproveStatusVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumLeaveApproveStatusVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumLeaveApproveStatusVM vm, string btn)
        {
