...
{
    [Authorize]
    public class EnumEmploymentTypeController : Controller
    {
        //
        // GET: /Enum/EnumEmploymentType/
        SymUserRoleRepo _reposur = new SymUserRoleRepo();
        ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
        EnumEmploymentTypeRepo _repo = new EnumEmploymentTypeRepo();
        #region Actions
        ...
        public ActionResult _index(JQueryDataTableParamVM param, string code, string name)
        {
            ...
            IEnumerable<EnumEmploymentTypeVM> filteredData;
            ...
            Func<EnumEmploymentTypeVM, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(EnumEmploymentTypeVM vm)
        {
        ...
        [HttpPost]
        public ActionResult Edit(EnumEmploymentTypeVM vm, string btn)
        {
            string[] result = new string[6];
            ShampanIdentity identity = (ShampanIdentity)Thread.CurrentPrincipal.Identity;
