...
namespace SymWebUI.Files.ReportFiles.HRM.Letters {
    ...
    public class rptConfirmationLetterG4s : ReportClass {
        
        public rptConfirmationLetterG4s() {
        }
        
        public override string ResourceName {
            get {
                return "rptConfirmationLetterG4s.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.HRM.Letters.rptConfirmationLetterG4s.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptConfirmationLetterG4s : Component, ICachedReport {
        
        public CachedrptConfirmationLetterG4s() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptConfirmationLetterG4s rpt = new rptConfirmationLetterG4s();
            rpt.Site = this.Site;
            return rpt;
        }
