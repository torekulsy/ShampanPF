...
namespace SymWebUI.Files.ReportFiles.HRM.NewReports {
    ...
    public class rptDependent : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.HRM.NewReports.rptDependent.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptDependent : Component, ICachedReport {
        
        public CachedrptDependent() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptDependent rpt = new rptDependent();
            rpt.Site = this.Site;
            return rpt;
        }
