...
namespace SymWebUI.Files.ReportFiles.HRM {
    ...
    public class rptEmployeeInfoByCode : ReportClass {
        
        public rptEmployeeInfoByCode() {
        }
        
        public override string ResourceName {
            get {
                return "rptEmployeeInfoByCode.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.HRM.rptEmployeeInfoByCode.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptEmployeeInfoByCode : Component, ICachedReport {
        
        public CachedrptEmployeeInfoByCode() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptEmployeeInfoByCode rpt = new rptEmployeeInfoByCode();
            rpt.Site = this.Site;
            return rpt;
        }
