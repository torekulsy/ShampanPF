...
namespace SymWebUI.Files.ReportFiles.Payroll.PayrollProcess {
    ...
    public class rptJournalLedger : ReportClass {
        
        public rptJournalLedger() {
        }
        
        public override string ResourceName {
            get {
                return "rptJournalLedger.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.Payroll.PayrollProcess.rptJournalLedger.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptJournalLedger : Component, ICachedReport {
        
        public CachedrptJournalLedger() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptJournalLedger rpt = new rptJournalLedger();
            rpt.Site = this.Site;
            return rpt;
        }
