...
namespace SymWebUI.Files.ReportFiles.Payroll.PayrollProcess {
    ...
    public class rptSalaryDeduction : ReportClass {
        
        public rptSalaryDeduction() {
        }
        
        public override string ResourceName {
            get {
                return "rptSalaryDeduction.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.Payroll.PayrollProcess.rptSalaryDeduction.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptSalaryDeduction : Component, ICachedReport {
        
        public CachedrptSalaryDeduction() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptSalaryDeduction rpt = new rptSalaryDeduction();
            rpt.Site = this.Site;
            return rpt;
        }
