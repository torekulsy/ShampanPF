...
namespace SymWebUI.Files.ReportFiles.Payroll.Salary {
    ...
    public class RptPaySlip_G4S : ReportClass {
        
        public RptPaySlip_G4S() {
        }
        
        public override string ResourceName {
            get {
                return "RptPaySlip_G4S.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.Payroll.Salary.RptPaySlip_G4S.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptPaySlip_G4S : Component, ICachedReport {
        
        public CachedRptPaySlip_G4S() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptPaySlip_G4S rpt = new RptPaySlip_G4S();
            rpt.Site = this.Site;
            return rpt;
        }
