...
namespace SymWebUI.Files.ReportFiles.Payroll.Salary {
    ...
    public class RptSalarySheet_BRACEPLBank : ReportClass {
        
        public RptSalarySheet_BRACEPLBank() {
        }
        
        public override string ResourceName {
            get {
                return "RptSalarySheet_BRACEPLBank.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.Payroll.Salary.RptSalarySheet_BRACEPLBank.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptSalarySheet_BRACEPLBank : Component, ICachedReport {
        
        public CachedRptSalarySheet_BRACEPLBank() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptSalarySheet_BRACEPLBank rpt = new RptSalarySheet_BRACEPLBank();
            rpt.Site = this.Site;
            return rpt;
        }
