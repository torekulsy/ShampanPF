...
namespace SymWebUI.Files.ReportFiles.Payroll.Salary {
    ...
    public class RptSalarySheet_KajolBank : ReportClass {
        
        public RptSalarySheet_KajolBank() {
        }
        
        public override string ResourceName {
            get {
                return "RptSalarySheet_KajolBank.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SymWebUI.Files.ReportFiles.Payroll.Salary.RptSalarySheet_KajolBank.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptSalarySheet_KajolBank : Component, ICachedReport {
        
        public CachedRptSalarySheet_KajolBank() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptSalarySheet_KajolBank rpt = new RptSalarySheet_KajolBank();
            rpt.Site = this.Site;
            return rpt;
        }
