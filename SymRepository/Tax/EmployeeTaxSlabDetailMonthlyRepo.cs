...
{
    public class EmployeeTaxSlabDetailMonthlyRepo
    {
        public List<EmployeeTaxSlabDetailVM> DropDown()
        {
            try
            {
                return new EmployeeTaxSlabDetailMonthlyDAL().DropDown();
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public List<EmployeeTaxSlabDetailVM> SelectAll(int Id = 0, int Schedule1Id = 0, string[] conditionFields = null, string[] conditionValues = null)
        {
            try
            {
                return new EmployeeTaxSlabDetailMonthlyDAL().SelectAll(Id, Schedule1Id, conditionFields, conditionValues);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public string[] Insert(EmployeeTaxSlabDetailVM vm)
        {
            try
            {
                return new EmployeeTaxSlabDetailMonthlyDAL().Insert(vm);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public string[] Delete(EmployeeTaxSlabDetailVM vm, string[] ids)
        {
            try
            {
                return new EmployeeTaxSlabDetailMonthlyDAL().Delete(vm, ids);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable Report(EmployeeTaxSlabDetailVM vm, string[] conditionFields = null, string[] conditionValues = null)
        {
            try
            {
                return new EmployeeTaxSlabDetailMonthlyDAL().Report(vm, conditionFields, conditionValues);
            }
            catch (Exception ex)
            {
                throw ex;
